...
def run_test_problem1a():
    ...
    # Test 3:
    expected = 1.255  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([10, 100], expected, test_results,
                                  format_string)
    actual = problem1a(10, 100)
    print_actual_result_of_test(expected, actual, test_results, precision=3)

    print_summary_of_test_results(test_results)
    # Test 4:
    expected = -0.4610  # This is APPROXIMATELY the correct answer.
    print_expected_result_of_test([30, 50], expected, test_results,
                                  format_string)
    actual = problem1a(30, 50)
    print_actual_result_of_test(expected, actual, test_results, precision=3)
...
def problem1a(m, n):
    ...
    for k in range(n**2-m**2+1):
        total = total+math.sin(k+abs(m)**2)
    return total
